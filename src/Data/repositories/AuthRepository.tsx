...
import { ChecklistEntities, RegisterProyEntities, User, PerfilEntities } from "../../Domain/Entities/User";
...
export class AuthRepositoryImpl implements AuthRepository {
  ...
  async getChecklists(userEmail? : undefined): Promise<ResponseApiDelivery> {
    try {
